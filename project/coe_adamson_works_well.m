function [ phi,theta ] = coe_adamson_works_well( phi0,theta0,phi_dot0,theta_dot0, t)
...
%   Detailed explanation goes here
	...
	[t, state] = ode45(@coe_adamson_solver, t, initCond, OPTIONS);
	...
	[t, state] = ode45(@coe_adamson_solver2, t, initCond, OPTIONS, times);
...
function ydot = coe_adamson_solver2(t, y, times)
